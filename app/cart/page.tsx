            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 border border-zinc-200 shadow-sm flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left w-full">
                <div className="flex justify-between items-start">
                  ...
                  <button onClick={() => toast.success("Removed item from cart!")} className="text-red-400 hover:text-red-600 transition-colors p-2 bg-red-50 hover:bg-red-100 rounded-full">
                    <Trash2 size={20} />
                  </button>
                </div>
              ...
              <form onSubmit={handleCheckout} className="space-y-4 mb-8">
                ...
                <div className="border-t border-zinc-100 pt-6 mt-6 space-y-4">
                  <div className="flex gap-4">
                    ...
                    <button type="button" onClick={() => toast.success("Coupon applied successfully!")} className="bg-zinc-900 text-white px-6 py-3 rounded-xl text-sm font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors">Apply</button>
                  </div>
